 ...
 */
public class RotateClockwise extends AbstractImageCommand {
   ...
   */
  public RotateClockwise(String in, String out) {
    super(in, out);
  }
  ...
  public void execute(ImageModel model) {
    ...
    model.setImage(out, ImageTransformUtil.rotate90Clockwise(image));
  }
}
